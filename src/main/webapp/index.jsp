    ...
    <div class="div-wrapper">
      ...
      <header>
        ...
        <div class="overlap-2">
          ...
          <p class="text-wrapper-11">운명과 인간의 선택: 네메시스의 메타포</p>
        ...
        <div class="overlap-3">
          <div class="view-2">
            ...
            <div class="text-wrapper-14">회원A</div>
            <div class="text-wrapper-15">1시간 전</div>
        ...
        <div class="overlap-4">
          <div class="view-3">
            ...
            <div class="ellipse-3"></div>
            <div class="text-wrapper-14">회원B</div>
            <div class="text-wrapper-15">1시간 전</div>
        ...
        <div class="text-wrapper-20">변환된 파일 이름.pdf</div>
        ...
        <div class="view-4">
          <div class="overlap-5">
            ...
            <div class="text-wrapper-21">책이랑</div>
          </div>
